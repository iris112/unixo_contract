(function() {
    ...
    (function() {
        ...
        var margin = {top: 20, right: 90, bottom: 30, left: 90},
            width = 1110 - margin.left - margin.right, // (window.innerWidth > 1110 ? 1110 : window.innerWidth - 137)
        ...
        root = d3.hierarchy(JSON.parse(tree.attr('data-tree')), function(d) { return d.children; });
        root.x0 = height / 2;
        root.y0 = 0;
